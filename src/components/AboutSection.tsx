    ...
    <section className="py-0 overflow-hidden">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[560px]">
        ...
        >
          ...
          >
            For over a decade, Capricorn Global Properties has been the trusted
            partner of high-net-worth individuals, diaspora investors, and
            institutional buyers seeking premium real estate across Africa's
            most vibrant cities.
          </motion.p>
          <motion.p
            variants={fadeInUp}
          ...
          >
            From the Atlantic shores of Lagos to the financial heart of Sandton,
            we combine deep local expertise with a global perspective to deliver
            unmatched results.
          </motion.p>
